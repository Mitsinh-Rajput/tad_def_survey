                ...
                children: [
                  ...
                  TextFormField(
                    controller: TextEditingController(
                        text: authController.QuestionSecondAnswer),
                    onChanged: (val) {
                      setState(() {
                  ...
                  return Column(
                    children: [
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            authController.QuestionfifthAnswer =
                        ...
                        child: Row(
                          children: [
                            ...
                            if (authController.QuestionFifthOption[index] ==
                                authController.QuestionfifthAnswer)
                              Container(
                                width: 130,
                                child: DropdownButton<String>(
                                  ...
                                  value:
                                      authController.QuestionfifthDropDownValue,
                                  onChanged: (String? newValue) {
                                    setState(() {
                                      authController
                                              .QuestionfifthDropDownValue =
                                          newValue;
                                    });
                                  },
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    controller: TextEditingController(
                        text: authController.QuestionSevenAnswer),
                    onChanged: (val) {
                      setState(() {
